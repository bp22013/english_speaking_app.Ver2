    ...
    .post('/deleteMessage', async (c) => {
        try {
            ...
            const targetMessage = await db
                .select()
                .from(messages)
                .where(and(eq(messages.id, messageIds[0]), eq(messages.senderId, senderId)))
                .limit(1);
            ...
            // contentがnullの場合とnullでない場合を分けて処理
            if (content !== null) {
            ...
            // messageTypeがnullの場合とnullでない場合を分けて処理
            if (messageType !== null) {
            ...
            // messagePriorityがnullの場合とnullでない場合を分けて処理
            ...
            // scheduledAtがnullの場合とnullでない場合を分けて処理
            if (scheduledAt !== null) {
